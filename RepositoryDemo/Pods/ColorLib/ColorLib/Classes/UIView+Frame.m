...
static NSString *VIEW_ASS_KEY = @"VIEWS";
...
- (NSObject *)customData{
    return objc_getAssociatedObject(self, (__bridge const void *)(VIEW_ASS_KEY));
}

- (void)setCustomData:(NSObject *)data{
    objc_setAssociatedObject(self, (__bridge const void *)VIEW_ASS_KEY, data, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}
